...
opArgs[0x0e] = function() { };
opName[0x0f] = "return";
opArgs[0x0f] = function(_code, _op, _dex) {
  _op.dest = _code.get();
};
...
opArgs[0x11] = function(_code, _op, _dex) {
  _op.dest = _code.get();
};

opName[0x12] = "const/4";
opArgs[0x12] = function(_fp, _op) {
  var x = _fp.get();
  _op.dest = highNibble(x);
...
opArgs[0x23] = function(_code, _out, _dex) {
  _out.dest = _code.get();
...
setArrayRange(opArgs,0x60,0x66,dest8field16);
opName[0x60] = "sget";
...
opArgs[0x70] = function(_code, _out, _dex) {
